...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <IconChevronDown className="h-4 w-4 text-ui-text-muted shrink-0" />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "py-1.5 pr-8 pl-2 text-xs font-semibold",
      "text-ui-text-muted",
      className,
    )}
    {...props}
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "rounded-lg py-2 pr-8 pl-2 text-sm text-right",
      "outline-none transition-colors duration-150",
      "text-ui-text",
      "focus:bg-brand-subtle focus:text-brand-dark",
  ...
  >
    <span
      className="absolute right-2 flex h-3.5 w-3.5
